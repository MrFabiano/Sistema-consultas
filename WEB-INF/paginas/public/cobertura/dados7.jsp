...
<div class="container-fluid" style="background:#EEF0F1; height:100%; width:100%;">
	<div class="row">
							...
							<div class="row">
								<div class="container">
									<div class="col-md-6 col-md-offset-3" >
										<h3 class="text-center" style="width: 100%; font-weight: 700;" >Relatório Raio-X
											</h3>
								    </div>
					              <div class="col-md-2">
 	...
 	<div id="fevereiro" class="tab-pane fade">
					...
					<div class="table-responsive">
						<table class="table table-bordered table-hover" style="background:#AAB7B8; color:"black" border="none" >
							<thead>
								<tr>
								    <c:forEach items="${colunasFevereiro}" var="coluna" >
										<th>${coluna.toString() }</th>
								  </c:forEach>
								</tr>
							</thead>
							<tbody>
				            	<c:forEach items="${anoFevereiro }" var="ano">
							   <tr class="resumo">
		...
		<div class="panel panel-default"
					style="margin-left: 20px; margin-right: 20px;">
				     ...
				     <div class="table-responsive" style="padding: 0;">
							...
							<thead>
								<tr>
								    <c:forEach items="${colunasFevereiroDetalhado}" var="colunas">
 	...
 	<div id="marco" class="tab-pane fade">
					...
					<div class="table-responsive">
						<table class="table table-bordered table-hover" style="background:#AAB7B8; color:"black" border="none" >
							<thead>
								<tr>
								    <c:forEach items="${colunasMarco}" var="coluna" >
										<th>${coluna.toString() }</th>
								  </c:forEach>
								</tr>
							</thead>
							<tbody>
				            	<c:forEach items="${anoMarco }" var="ano">
							   <tr class="resumo">
		...
		<div class="panel panel-default"
					style="margin-left: 20px; margin-right: 20px;">
				     ...
				     <div class="table-responsive" style="padding: 0;">
							...
							<thead>
								<tr>
								    <c:forEach items="${colunasMarcoDetalhado}" var="colunas">
										<th>${colunas.toString() }</th>
									</c:forEach>
								</tr>
								</thead>
 	...
 	<div id="abril" class="tab-pane fade">
					...
					<div class="table-responsive">
						<table class="table table-bordered table-hover" style="background:#AAB7B8; color:"black" border="none" >
							<thead>
								<tr>
								    <c:forEach items="${colunasAbril}" var="coluna" >
										<th>${coluna.toString() }</th>
								  </c:forEach>
								</tr>
							</thead>
							<tbody>
				            	<c:forEach items="${anoAbril }" var="ano">
							   <tr class="resumo">
		...
		<div class="panel panel-default"
					style="margin-left: 20px; margin-right: 20px;">
				     ...
				     <div class="table-responsive" style="padding: 0;">
							...
							<thead>
								<tr>
								    <c:forEach items="${colunasAbrilDetalhado}" var="colunas">
										<th>${colunas.toString() }</th>
									</c:forEach>
								</tr>
								</thead>
...
<c:if test="${referencia}">	
			<div class="col-lg-12">
				<div class="col-lg-12 referencias">
					<div class="panel panel-default">
						<div class="panel-heading tabela">
							<p class="text-center" style="width: 100%; margin: 0">Referências</p>
						</div>
					<div class="panel-body" style="padding: 0;">
							<div class="table-responsive">
								<table class="table table-striped">
									<tbody>
										<tr>
											<td>FONTE: Folha de Pagamento dos PTRs
                                                     Elaboração SMADS/CGB</td>
										</tr>
										
											<tr>
											<td>Fonte Folhas de pagamento dos PTRs 	
                                                Elaboração: SMADS/CGB		
                                                *Os valores transferidos pelo PETI estão dentro da folha de pagamento do PBF.</td>
								            </tr>
										</tbody>
								</table>
							</div>
