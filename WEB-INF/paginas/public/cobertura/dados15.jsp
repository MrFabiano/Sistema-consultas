...
<div class="tab-content" >
		 ...
		 <div id="janeiro" class="tab-pane fade in active" >
				  ...
				  <c:otherwise>
							<div class="row">
								<div class="col-md-6 col-md-offset-3" >
									<h3 class="text-center" style="width: 100%; font-weight: 700;">  </h3>
							   </div>
						   </div>
		           </c:otherwise>
		           </c:choose>
		      <div class="table-responsive" align="right" >
				     ...
				     <c:if    
			              test="${not iframeJaneiro.equals('') && not empty iframeJaneiro }">
						    <iframe width='45%  margin: 0;' height='540px;' align='right' seamless frameborder='0'
			          ...
			          <table class="table table-bordered" style="width: 55%; align="right"  style="color:black;"   >
						   ...
						   <thead>
								<tr style="background:#025a94;color:white" align="center" border="none">
					...
					<tbody>
								<c:forEach items="${anoJaneiro.subList(5,6) }"  var="ano">
								   <tr class="resumo" align="center" style="background:#025a94;color:white" border="none">
		      ...
		      <div class="table-responsive" align="right" >
				     ...
				     <c:if    
			              test="${not iframeFevereiro.equals('') && not empty iframeFevereiro }">
						    <iframe width='45%  margin: 0;' height='560px;' align='right' seamless frameborder='0'
